...
<svg width="500" height="100" viewBox="0 0 500 100">
  ...
  <rect x="5" y="5" width="490" height="90" rx="15" fill="none" stroke="url(#rgb-gradient)" stroke-width="5" />
  <text x="50%" y="60%" dominant-baseline="middle" text-anchor="middle" font-family="Arial" font-size="35" font-weight="bold" fill="white">
    ༺Ali™ Linux CS༻
  </text>
</svg>
...
A passionate developer with deep expertise in low-level programming (Assembly, C), web development, Android development, Desktop apps (Win, Linux), and embedded systems.
</p>
